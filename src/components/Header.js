...
export default function Header() {
  return (
    ...
    <div className="bg-brand-color">
        ...
        <div className="container mx-auto md:hidden flex items-center h-10 px-3 justify-between ">
        <div className="flex items-center gap-x-2 text-sm font-semibold text-gray-800">
        <FaLocationDot size={18} className="text-primary-brand-color" />
        Teslimat Adresi Belirle
        </div>
        <RiArrowRightSLine size={18} className="text-primary-brand-color" />
        </div>
        </>
